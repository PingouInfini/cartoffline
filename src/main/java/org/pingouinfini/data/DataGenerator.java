package org.pingouinfini.data;

import org.pingouinfini.ExportGenerator;
import org.pingouinfini.Main;
...
public class DataGenerator {
    public static void generatePointsSample(Path outputPath, List<Point> points, List<Feature> features) throws IOException {
        // === POINT 1 ===
        ...
        // === POINT 6 ===
        String resourcePath4 = "/samples/images/chateau_saint_germain.jpg";
        ...
        Point p6 = new Point(48.89786143956828, 2.096084900767872).name("Château Vieux de Saint-Germain-en-Laye").description("Le château de Saint-Germain-en-Laye qui abrite aujourd’hui le musée d’Archéologie nationale est un lieu chargé d’histoire. Il a été jusqu’au règne de Louis XIV l’une des demeures favorites des rois de France en raison de sa forêt pour la chasse et de l’air de Saint-Germain réputé excellent.").filename(fileName4).displayLayer(DisplayLayer.OBJET).build();
        points.add(p6);
        features.add(ExportGenerator.createPointFeature(p6));
    }

    public static void generatePolygonsSample(Path outputPath, List<org.pingouinfini.geojson.Polygon> polygons, List<Feature> features) throws IOException {
        // === POLYGON 1 ===
        String resourcePath5 = "/samples/images/grand_canal_versailles.jpg";
        String fileName5 = Paths.get(resourcePath5).getFileName().toString();
        Image image5 = ImageIO.read(Objects.requireNonNull(Main.class.getResourceAsStream(resourcePath5)));
        ExportGenerator.saveImage(image5, outputPath, fileName5);
        ...
        org.pingouinfini.geojson.Polygon poly1 = new org.pingouinfini.geojson.Polygon(polygonRing1, "Grand Canal de Versailles", "Plus grand bassin du parc du château de Versailles. En forme de croix, il fut construit entre 1667 et 1679, à l'instigation de Le Nôtre.")
                .borderColor("darkblue").filename(fileName5).fillPattern(FillPattern.NONE).weight(3.0).lineStyle(LineStyle.DASH).displayLayer(DisplayLayer.OBJET);
        polygons.add(poly1);
        ...
        org.pingouinfini.geojson.Polygon poly2 = new org.pingouinfini.geojson.Polygon(polygonRing2);
        polygons.add(poly2);
        ...
        org.pingouinfini.geojson.Polygon poly3 = new org.pingouinfini.geojson.Polygon(polygonRing3).name("INRAE").fillPattern(FillPattern.FULL).lineStyle(LineStyle.DOT)
        ...
        org.pingouinfini.geojson.Polygon poly4 = new org.pingouinfini.geojson.Polygon(polygonRing4).name("STAT").fillPattern(FillPattern.DIAGONAL_LEFT).fillColor("RED")
        ...
        org.pingouinfini.geojson.Polygon poly5 = new org.pingouinfini.geojson.Polygon(polygonRing5).name("Parly2").fillPattern(FillPattern.DIAGONAL_RIGHT)
        ...
        org.pingouinfini.geojson.Polygon poly6 = new org.pingouinfini.geojson.Polygon(polygonRing6).name("Mairie Versailles").fillPattern(FillPattern.GRID)
        ...
        org.pingouinfini.geojson.Polygon poly7 = new org.pingouinfini.geojson.Polygon(polygonRing7).name("Gare des Chantiers").fillPattern(FillPattern.MESH)
        ...
        org.pingouinfini.geojson.Polygon poly8 = new org.pingouinfini.geojson.Polygon(polygonRing8).name("Chateau").fillPattern(FillPattern.HORIZONTAL)
        ...
        org.pingouinfini.geojson.Polygon poly9 = new Polygon(polygonRing9).name("Préfecture").fillPattern(FillPattern.VERTICAL)
    ...
    public static void generateLinesSample(List<Feature> features) {
        // === LINE 1 ===
